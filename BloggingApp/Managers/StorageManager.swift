...
final class StorageManager {
    ...
    public func downloadUrlForProfilePicture(path: String,
    ...
    public func uploadBlogHeaderImage(
        ...
        container
            .reference(withPath: "post_headers/\(path)/\(postId)photo.png")
            .putData(pngData, metadata: nil) { metaData, error in
                guard metaData != nil, error != nil else {
                    completion(false)
                    return
    ...
    public func downloadUrlForPostHeader(email: String,
        ...
        container
            .reference(withPath: "post_headers/\(emailComponent)/\(postId)photo.png")
